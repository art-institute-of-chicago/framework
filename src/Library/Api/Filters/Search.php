...
namespace Aic\Hub\Foundation\Library\Api\Filters;
...
class Search extends FreeTextSearch
{
    public function applyFilter(Builder $builder): Builder
    {
        if (!empty($this->searchString) && $this->searchColumns !== []) {
            ...
            // \Aic\Hub\Foundation\Library\Api\Models\BaseApiModel; with \Aic\Hub\Foundation\Library\Api\Models\Behaviors\HasApiCalls::rawSearch()
